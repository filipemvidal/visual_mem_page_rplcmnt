...
class GuiView:
    ...
    def run(self, references):
        ...
        self.__run_simulation(FCFS, capacity=3, references=references, table_obj=FCFS_table)
        self.__run_simulation(LRU, capacity=3, references=references, table_obj=LRU_table)
        self.__run_simulation(LFU, capacity=3, references=references, table_obj=LFU_table)
